(function() {
  var BOOL, CALLABLE, CODE, COFFEE_ALIASES, COFFEE_ALIAS_MAP, COFFEE_KEYWORDS, COMMENT, COMPARE, COMPOUND_ASSIGN, HEREDOC, HEREDOC_ILLEGAL, HEREDOC_INDENT, HEREGEX, HEREGEX_OMIT, IDENTIFIER, INDEXABLE, INVERSES, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LINE_BREAK, LINE_CONTINUER, LOGIC, Lexer, MATH, MULTILINER, MULTI_DENT, NOT_REGEX, NOT_SPACED_REGEX, NUMBER, OPERATOR, REGEX, RELATION, RESERVED, Rewriter, SHIFT, SIMPLESTR, TRAILING_SPACES, UNARY, WHITESPACE, compact, count, flatten, key, last, starts, _ref, _ref2,
    __indexOf = Array.prototype.indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  _ref = require('./rewriter'), Rewriter = _ref.Rewriter, INVERSES = _ref.INVERSES;

  _ref2 = require('./helpers'), count = _ref2.count, starts = _ref2.starts, compact = _ref2.compact, last = _ref2.last, flatten = _ref2.flatten;
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      var blocks, i, lastToken, lastTokenHadNewLine, lastTokenLineNumber, line, lineBlocks, lineNumber, res, semi, stringToken, t, tag, tm, tmp, _i, _j, _len, _len2, _ref3, _ref4, _ref5;
      if (opts == null) opts = {};
      ...
      if (this.options.debug) {
        ...
        for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
          t = _ref3[_i];
          tmp.push(t);
          if (lastToken && lastToken.newLine && lastToken[0] !== 'TERMINATOR') {
            lastTokenHadNewLine = true;
          }
          if (lastTokenHadNewLine) lastTokenLineNumber = lastToken[2];
          if (t[0] === 'TERMINATOR' || ((_ref4 = t[0], __indexOf.call(lineBlocks, _ref4) >= 0) && lastTokenHadNewLine)) {
            if (t[0] === 'TERMINATOR') lastTokenHadNewLine = false;
            line = '"/*line ';
            lineNumber = t[2];
            if (lastToken) lineNumber = lastToken[2];
            if (lastTokenHadNewLine) lineNumber = lastTokenLineNumber;
            line += lineNumber + 1 + ' */"';
            ...
            res.push([']', ']', lineNumber]);
            res.push(['TERMINATOR', "\n", lineNumber]);
            for (_j = 0, _len2 = tmp.length; _j < _len2; _j++) {
              tm = tmp[_j];
              res.push(tm);
            }
            line = '';
          ...
          if (_ref5 = t[0], __indexOf.call(blocks, _ref5) < 0) lastToken = t;
        }
        this.tokens = res;
      }
