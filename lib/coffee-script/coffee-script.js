(function() {
  ...
  exports.postCompilationMatchLines = function(code) {
    var curLine, k, line, lines, newLines, _i, _len;
    lines = code.split("\n");
    newLines = [];
    curLine = 0;
    for (_i = 0, _len = lines.length; _i < _len; _i++) {
      ...
      if (line.indexOf("*/") === 0 && newLines[curLine] === "") {
        line = line.substring(2);
      }
      newLines[curLine] += line;
    }
    for (k in newLines) {
      if (!__hasProp.call(newLines, k)) continue;
      line = newLines[k];
      if (line === "undefined") newLines[k] = "";
    }
